...
Game.PlayGame.prototype = {
	...
	create : function(){
		...
		this.game.world.bounds.width = 590;

		this.game.world.bounds.height = 590;



		this.logo = this.game.add.sprite(615, 30, 'logo');
		...
		this.nextblock = new Block(this.game, 650, 271, this.nextblocktype, this.nextblockcolor, 1);
		...
		this.scoretext = this.add.text(665, 355, 'SCORE', { font: '15px Arial', fill: '#ff0044', align: 'center' });

		this.scoretext.anchor.setTo(0.5, 0.5);

		this.scoretextmain = this.add.text(660, 370, " "+score+" ", { font: "15px Arial", fill: "#fff", align: "center" })

		

		this.resetbutton = this.add.sprite(650,520,'reset');

		this.pausebutton = this.add.sprite(650,460,'pause');
